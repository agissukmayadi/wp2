					...
					<div class="col-4">
						...
						<form action="<?= current_url() ?>" method="post">
							...
							<div class="form-check">
								<input class="form-check-input" type="radio" name="status" id="invalid_license"
									value="INVALID LICENSE">
								<label class="form-check-label" for="invalid_license">
									Invalid License
								</label>
							</div>
							<div class="form-check">
								<input class="form-check-input" type="radio" name="status" id="invalid_payment"
									value="INVALID PAYMENT">
								<label class="form-check-label" for="invalid_payment">
									Invalid Payment
								</label>
							</div>
							<div class="form-check">
